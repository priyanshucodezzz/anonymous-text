...
import suggestMessagesArray from "@/suggestMessages.json"
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      ...
      <div className="mt-4 flex flex-col py-6 px-12 gap-6 border-black/30 border-[0.5px] rounded-md">
        ...
        {suggestMessagesArray && suggestMessagesArray.slice(randomNumber,  randomNumber+3).map((suggestmsg , index)=> (
          <div onClick={()=> setMessageContent(suggestmsg.text)} key={index} className="p-3 border-black/30 border-[0.5px] rounded-md cursor-pointer hover:bg-black hover:text-white">
